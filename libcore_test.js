...
function test0013()
{
	...
	if (z.length != 3) { console.log('ERROR[' + arguments.callee.name + '()]: step001'); return false; }
	if (z[0] != 1) { console.log('ERROR[' + arguments.callee.name + '()]: step002'); return false; }
	if (z[1] != 2) { console.log('ERROR[' + arguments.callee.name + '()]: step003'); return false; }
	if (z[2] != 3) { console.log('ERROR[' + arguments.callee.name + '()]: step004'); return false; }
...
function test0016()
{
	...
	for (;;)
	{
		...
		if ((y instanceof Array) === false) { console.log('ERROR[' + arguments.callee.name + '()]: step001'); return false; }
		if (y.length != 2) { console.log('ERROR[' + arguments.callee.name + '()]: step002'); return false; }
		if ((x[0] != 1) || (x[1] != 2)) { console.log('ERROR[' + arguments.callee.name + '()]: step003'); return false; }
		...
		count++;
		if (count == 1000) { console.log('ERROR[' + arguments.callee.name + '()]: step004'); return false; }
	}
